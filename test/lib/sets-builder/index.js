...
const fs = require('fs');
const SetBuilder = require('build/lib/sets-builder');
const SetCollection = require('build/lib/sets-builder/set-collection');
const TestSet = require('build/lib/sets-builder/test-set');

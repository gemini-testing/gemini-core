...
const fs = require('fs');
const SetBuilder = require('build/lib/sets-builder').default;
const SetCollection = require('build/lib/sets-builder/set-collection').default;
const TestSet = require('build/lib/sets-builder/test-set').default;

...
const fs = require('fs');
const SetBuilder = require('lib/sets-builder');
        ...
        it('should expand files from sets using passed glob options and project root', () => {
            ...
            return createSetBuilder(sets)
                ...
                .then(() => {
                    ...
                    assert.calledWith(expandSetFiles, {formats: ['.js', '.ts'], root: '/root'}, {glob: 'opts'});
                });
        });
        ...
        it('should expand passed files with passed glob options', () => {
            ...
            return createSetBuilder()
                ...
                .then(() => {
                    ...
                    assert.calledWith(globExtra.expandPaths, ['some/files'], sinon.match({formats: ['.js', '.ts']}), globOpts);
                });
        });

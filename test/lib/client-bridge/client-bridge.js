...
const ClientBridge = require('build/lib/client-bridge/client-bridge');
const ClientBridgeError = require('build/lib/errors/client-bridge-error');
    ...
    describe('call', () => {
        ...
        describe('if scripts were not injected', () => {
            ...
            it('should try to inject scripts', () => {
                ...
                return performCall()
                    .then(() => assert.calledWith(browser.injectScript, script));
            });

...
class SetsBuilder {
    ...
    build(projectRoot, globOpts = {}, fileExtensions = FILE_EXTENSIONS) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this._transformDirsToMasks();
            this._resolvePaths(projectRoot);
            const expandedFiles = yield globExtra.expandPaths(this._filesToUse, expandOpts, globOpts);
            this._validateFoundFiles(expandedFiles);
            this._useFiles(expandedFiles);
            yield this._expandFiles(expandOpts, globOpts);

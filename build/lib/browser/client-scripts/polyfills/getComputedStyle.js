...
function getComputedStylePixel(element, property, fontSize) {
    ...
    value = element.document && element.currentStyle[property].match(/([\d\.]+)(%|cm|em|in|mm|pc|pt|)/) || [0, 0, ''], size = value[1], suffix = value[2], rootSize;
...
function CSSStyleDeclaration(element) {
    var currentStyle = element.currentStyle, fontSize = getComputedStylePixel(element, 'fontSize'), unCamelCase = function (match) {

...
exports.prepareScreenshot = function prepareScreenshot(selectorsOrArea, opts) {
    opts = opts || {};
    try {
        return prepareScreenshotUnsafe(selectorsOrArea, opts);
    } catch (e) {
        return {
            error: 'JS',
...
function prepareScreenshotUnsafe(selectorsOrArea, opts) {
    ...
    if (Rect.isRect(selectorsOrArea)) {
        rect = new Rect(selectorsOrArea);
    } else {
        rect = getCaptureRect(selectorsOrArea, {allowViewportOverflow: allowViewportOverflow, scrollElem: scrollElem});
    }

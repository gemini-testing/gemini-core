...
module.exports = class Viewport {
    ...
    constructor(viewport, image, pixelRatio, {allowViewportOverflow, insideViewport} = {}) {
        this._viewport = _.clone(viewport);
        this._image = image;
        this._pixelRatio = pixelRatio;
        this._allowViewportOverflow = allowViewportOverflow;
        this._insideViewport = insideViewport;
    }

    validate(captureArea, browser) {
        CoordValidator.create(
            browser, {allowViewportOverflow: this._allowViewportOverflow, insideViewport: this._insideViewport}
        ).validate(this._viewport, captureArea);
    }

...
export default class CoordValidator {
    ...
    public static create(browser: ExistingBrowser, opts: CoordValidatorOpts): CoordValidator {
     ...
     */
    public validate(viewport: SerializedRect, cropArea: SerializedRect): void {

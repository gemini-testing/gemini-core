...
module.exports = class CoordValidator {
     ...
     */
    constructor(browser, {allowViewportOverflow = false, insideViewport = false} = {}) {
    ...
    _reportOffsetViewportError() {
        ...
        const message = `Can not capture the specified region of the viewport.
            ...
            Or if viewport overflow is expected behavior then you can use
            option "allowViewportOverflow" or "insideViewport" in "assertView" command.`;

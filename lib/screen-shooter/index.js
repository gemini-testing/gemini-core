...
module.exports = class ScreenShooter {
    ...
    capture(page, {screenshotDelay, allowViewportOverflow = false, insideViewport = false} = {}) {
        return this._browser.captureViewportImage(page, screenshotDelay)
            .then((viewportImage) => Viewport.create(page.viewport, viewportImage, page.pixelRatio, {allowViewportOverflow, insideViewport}))

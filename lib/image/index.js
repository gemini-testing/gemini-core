...
const debug = require('debug')('hermione:image');
...
module.exports = class Image {
    ...
    static fromBase64(base64) {
        debug(`inside "fromBase64", before create new buffer`);
        const newBuffer = new Buffer(base64, 'base64');
        console.log('newBuffer is created!!!');
        return new Image(newBuffer);
    }
